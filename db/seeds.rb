...
t9 = Task.create(:name => 'Go Topless', :description => 'Ditch the lid or straw on your beverage', :category => 'Shopping', :score => 2, :image => 'http://res.cloudinary.com/dyi0udlrl/image/upload/v1524465433/coffee-cup-740x385.jpg')
